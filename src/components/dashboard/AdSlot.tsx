...
const ADSENSE_DISPLAY_SLOT_ID =
  process.env.NEXT_PUBLIC_ADSENSE_DISPLAY_SLOT_ID || '';
const ADSENSE_MULTIPLEX_SLOT_ID =
  process.env.NEXT_PUBLIC_ADSENSE_MULTIPLEX_SLOT_ID || '';
...
export function AdSlot({ id, className, variant = 'top' }: AdSlotProps) {
  ...
  return (
    <div
      ...
      className={clsx(
        ...
        variant === 'mobile' && 'fixed inset-x-3 bottom-3 z-[9999] md:hidden',
        className,
      )}
      style={{
