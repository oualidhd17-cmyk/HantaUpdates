...
export default function HantavirusCountryPage({ params }: CountryPageProps) {
  ...
  useEffect(() => {
    ...
    void params.then((resolvedParams) => {
      ...
      setCountrySlug(normalizeSlug(resolvedParams.country));
    });
  ...
  const country = useMemo(() => {
    ...
    return (
      countries.find((item) => slugifyCountry(item.country) === countrySlug) ??
      null
    );
